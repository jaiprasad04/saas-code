                ...
                <div className="relative border-2 border-dashed border-divider hover:border-primary/50 transition-colors rounded-lg h-32 flex flex-col items-center justify-center bg-bg-page/40 p-4">
                  {sourceImage ? (
                    <div className="w-full h-full relative group">
                      <img src={sourceImage} alt="Source frame" className="w-full h-full object-contain rounded" />
                      <button
                        type="button"
                ...
                <div className="grid grid-cols-4 gap-2">
                  {DURATION_PRESETS.map((d) => (
                    <button
                      ...
                      className={`py-2 rounded border text-xs font-bold flex flex-col items-center gap-1 transition-all ${
                        duration === d.value ? "border-primary bg-primary/10 text-primary-text" : "border-divider bg-bg-page/20 text-secondary-text hover:bg-bg-card"
                      }`}
                    >
                      <span className="text-sm">{d.value}s</span>
                      <span className="text-[8px] opacity-70">{d.label.split(" ")[1]}</span>
                    </button>
                  ))}
                </div>
                <input
                ...
                isVideoOutput(activeCreation.resultImage) ? (
                  <div className="relative w-full h-full group">
                    ...
                    <button
                      ...
                      className="absolute bottom-3 left-3 bg-black/60 backdrop-blur-sm text-white rounded-full w-10 h-10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer active:scale-90"
                    >
